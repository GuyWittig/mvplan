...
public class SegmentDive extends SegmentAbstract
{
    ...
    public String toStringLong()
    {
        ...
        return String.format("DIVE:%1$3.0f"+Prefs.getPrefs().getDepthShortString()+" for %2$02d:%3$02d [%4$3.0f] on %5$s, SP: %6$3.1f, END:%7$3.0f"+Prefs.getPrefs().getDepthShortString(),
