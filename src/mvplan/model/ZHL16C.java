 ...
 * ZHL16C.java <br/>
 *
 * Modified 3-Jan-16 for Imperial ZHL16-C aN2 coefficients
 *
...
public class ZHL16C extends AbstractZHL16Model implements Serializable
{
    ...
    protected void setTimeConstants(){
        ...
        if(units == METRIC) {
            ...
            tissues[4].setCompartmentTimeConstants(10.21,   27.0,   30.03,  0.7582, 20.19,  0.8126);
            tissues[5].setCompartmentTimeConstants(14.48,   38.3,   26.72,  0.7957, 16.43,  0.8434);
            tissues[6].setCompartmentTimeConstants(20.53,   54.3,   23.79,  0.8279, 14.36,  0.8693);
            tissues[7].setCompartmentTimeConstants(29.11,   77.0,   21.18,  0.8553, 13.03,  0.8910);
            tissues[8].setCompartmentTimeConstants(41.20,   109.0,  19.38,  0.8757, 12.21,  0.9092);
            tissues[9].setCompartmentTimeConstants(55.19,   146.0,  18.06,  0.8903, 11.40,  0.9222);
            tissues[10].setCompartmentTimeConstants(70.69,  187.0,  17.37,  0.8997, 10.73,  0.9319);
            tissues[11].setCompartmentTimeConstants(90.34,  239.0,  16.90,  0.9073, 09.98,  0.9403);
            tissues[12].setCompartmentTimeConstants(115.29, 305.0,  16.87,  0.9122, 09.23,  0.9477);
            tissues[13].setCompartmentTimeConstants(147.42, 390.0,  16.86,  0.9171, 08.50,  0.9544);
            tissues[14].setCompartmentTimeConstants(188.24, 498.0,  16.84,  0.9217, 08.08,  0.9602);
