...
public class OxTox {
    ...
    public void addO2( double time, double pO2){
        ...
        // CNS Calculations
        // GW: 11-Apr-11 - Updated with some numbers from Steve Burton - still probably ill defined
        if (pO2>1.8)        exposure=1; 
        else if (pO2>1.7)   exposure=2;
        else if (pO2>1.6 )  exposure=10;
    ...
    /**
     * Gets the maximum ppO2 encountered
     * @return Maximum ppO2
     */
