...
public class PrefsDialog extends JDialog implements ActionListener, FocusListener
{
    ...
    public PrefsDialog(Frame frame)
    {
        ...
        gfPanel.add(gfHigh);
        gfPanel.setPreferredSize(new Dimension(180,80));
        ...
        stopPanel.setPreferredSize(new Dimension(180,100));
        ...
        divePanel.setPreferredSize(new Dimension(180,100));
        ...
        gasPanel.setPreferredSize(new Dimension(180,80));
